let handler = async (m, { conn }) => {
  ...
  if (m.sender.startsWith('62') || m.sender.startsWith('+62')) {
    var txt = `
(Indonesian)
**Ketentuan Layanan (TOS) - GO-BOT**
Dengan menggunakan GO-BOT, Anda setuju dengan ketentuan berikut:
...
Dengan menggunakan GO-BOT, Anda setuju dengan semua ketentuan yang berlaku.
...
`
    ...
    txt = `
(English)
**Term of Service (TOS) - GO-BOT**
By using GO-BOT, you agree to the following terms:
...
By using GO-BOT, you agree to abide by all applicable terms.
    ...
    extendedTextMessage: {
      ...
      contextInfo: {
        ...
        externalAdReply: {
          ...
          sourceUrl: 'https://www.instagram.com/yaelah_sal',
        }
      }, mentions: [m.sender]
    }
  }, { quoted: fkon });
